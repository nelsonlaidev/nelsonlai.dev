...
export const GET = async (_request: Request, props: RouteContext<'/[locale]/account/settings/og-image.png'>) => {
  const { params } = props
  ...
  try {
    ...
    return new ImageResponse(<OGImage title={title} url='/account/settings' />, {
