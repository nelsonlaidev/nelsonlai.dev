...
const DrawerClose = (props: DrawerCloseProps) => <DrawerPrimitive.Close data-slot='drawer-close' {...props} />
...
const DrawerHeader = (props: DrawerHeaderProps) => {
  ...
  return <div data-slot='drawer-header' className={cn('flex flex-col gap-1.5 p-4', className)} {...rest} />
}
