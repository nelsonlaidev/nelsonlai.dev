    ...
    <MenuPrimitive.Portal>
      ...
      >
        <MenuPrimitive.Popup
          ...
          className={cn(
            `
              z-50 max-h-(--available-height) w-(--anchor-width) min-w-48 origin-(--transform-origin) overflow-x-hidden
              overflow-y-auto rounded-2xl bg-popover p-1 text-popover-foreground shadow-2xl ring-1 ring-foreground/5
...
function DropdownMenuItem(props: DropdownMenuItemProps) {
  ...
  return (
    <MenuPrimitive.Item
      ...
      className={cn(
        `
          group/dropdown-menu-item relative flex cursor-default items-center gap-2.5 rounded-xl px-3 py-2 text-sm
...
function DropdownMenuSubContent(props: DropdownMenuSubContentProps) {
  ...
  return (
    <DropdownMenuContent
      ...
      className={cn(
        `
          w-auto min-w-36 rounded-2xl bg-popover p-1 text-popover-foreground shadow-2xl ring-1 ring-foreground/5
          duration-100
          data-[side=bottom]:slide-in-from-top-2
          data-[side=left]:slide-in-from-right-2
          data-[side=right]:slide-in-from-left-2
