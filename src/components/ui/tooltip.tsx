    ...
    <TooltipPrimitive.Portal>
      ...
      >
        <TooltipPrimitive.Popup
          ...
          className={cn(
            `
              z-50 w-fit max-w-xs origin-(--transform-origin) rounded-2xl bg-foreground px-3 py-1.5 text-xs
              text-background
        ...
        >
          ...
          <TooltipPrimitive.Arrow
            className='
              ...
              data-[side=inline-end]:top-1/2! data-[side=inline-end]:-left-1 data-[side=inline-end]:translate-x-[1.5px]
              data-[side=inline-end]:-translate-y-1/2
              data-[side=inline-start]:top-1/2! data-[side=inline-start]:-right-1
              data-[side=inline-start]:translate-x-[-1.5px] data-[side=inline-start]:-translate-y-1/2
              data-[side=left]:top-1/2! data-[side=left]:-right-1 data-[side=left]:translate-x-[-1.5px]
              data-[side=left]:-translate-y-1/2
              data-[side=right]:top-1/2! data-[side=right]:-left-1 data-[side=right]:translate-x-[1.5px]
