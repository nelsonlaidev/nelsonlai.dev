...
function SelectTrigger(props: SelectTriggerProps) {
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        `
          flex w-fit items-center justify-between gap-1.5 rounded-4xl border border-input bg-input/30 px-3 py-2 text-sm
        ...
        <SelectPrimitive.Popup
          ...
          className={cn(
            `
              ...
              overflow-x-hidden overflow-y-auto rounded-2xl bg-popover text-popover-foreground shadow-2xl ring-1
...
function SelectItem(props: SelectItemProps) {
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        `
          relative flex w-full cursor-default items-center gap-2.5 rounded-xl py-2 pr-8 pl-3 text-sm outline-hidden
          select-none
